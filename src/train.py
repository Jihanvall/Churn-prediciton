...
def train_and_save_model(raw_data_path):
    ...
    logger.info("Applying feature engineering, encoding, scaling, and SMOTENC...")
   ...
   # SMOTENC already balances the training classes 1:1, so no extra
    ...
    logger.info("Success: Training complete and artifacts saved in the 'models' directory.")
